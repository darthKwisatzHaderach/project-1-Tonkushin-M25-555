...
COMMANDS = {
    ...
    "north|south|east|west": "двигаться по направлению (короткая форма)",
}

# Вероятности/пороговые значения для случайных событий и ловушек
EVENT_PROBABILITY = 10  # шанс срабатывания события: 1/10
RANDOM_EVENT_KINDS = 3  # число вариантов случайных событий
TRAP_DEATH_THRESHOLD = 3  # выпадет [0..9], < 3 означает поражение
